...
rtma_temp = rtma_data['Temperature_error_height_above_ground'].squeeze()

rtma_temp_24 = rtma_data_24['Temperature_error_height_above_ground'].squeeze()

# Converts Temperature to F
def TEMP_data(rtma_temp, rtma_temp_24):
    degF = rtma_temp * 0.5556
    degF_24 = rtma_temp_24 * 0.5556
...
error, error_24 = TEMP_data(rtma_temp, rtma_temp_24)
